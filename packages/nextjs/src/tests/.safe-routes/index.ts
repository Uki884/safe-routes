...
export const safeRoutes = {
  "/login/": {
    ...
    // @ts-ignore
    searchParams:
      {} as import("../../fixtures/app/(auth)/login/page.tsx").SearchParams,
  },
  "/about/": {
    params: {} as Record<string, never>,
    // @ts-ignore
    searchParams:
      {} as import("../../fixtures/app/about/page.tsx").SearchParams,
  },
  "/blog/[slug]/": {
    params: {} as { slug: string | number },
    // @ts-ignore
    searchParams:
      {} as import("../../fixtures/app/blog/[slug]/page.tsx").SearchParams,
  },
  "/": {
    params: {} as Record<string, never>,
    // @ts-ignore
  ...
  "/products/": {
    ...
    // @ts-ignore
    searchParams:
      {} as import("../../fixtures/app/products/[[...filters]]/page.tsx").SearchParams,
  },
  "/products/[[...filters]]/": {
  ...
  "/search/": {
    ...
    // @ts-ignore
    searchParams:
      {} as import("../../fixtures/app/search/page.tsx").SearchParams,
  },
  "/shop/[...categories]/": {
    params: {} as { categories: string[] | number[] },
    // @ts-ignore
    searchParams:
      {} as import("../../fixtures/app/shop/[...categories]/page.tsx").SearchParams,
  },
  "/shop/": {
    params: {} as Record<string, never>,
    // @ts-ignore
  ...
  "/users/[id]/": {
    ...
    // @ts-ignore
    searchParams:
      {} as import("../../fixtures/app/users/[id]/page.tsx").SearchParams,
  },
  "/users/[user-id]/": {
    params: {} as { userId: string | number },
    // @ts-ignore
    searchParams:
      {} as import("../../fixtures/app/users/[user-id]/page.tsx").SearchParams,
  },
  "/users/[userId]/posts/[postId]/": {
    params: {} as { userId: string | number; postId: string | number },
    // @ts-ignore
    searchParams:
      {} as import("../../fixtures/app/users/[userId]/posts/[postId]/page.tsx").SearchParams,
  },
  "/users/[user_id]/": {
    params: {} as { userId: string | number },
    // @ts-ignore
    searchParams:
      {} as import("../../fixtures/app/users/[user_id]/page.tsx").SearchParams,
  },
} as const;
